...
class GlobalExceptionHandler<T : Activity> private constructor(
    ...
    private fun <T : Activity> Context.launchActivity(activity: Class<T>, exception: Throwable) {
        val crashedIntent =
    ...
    companion object {
        ...
        private const val defFlags =
            Intent.FLAG_ACTIVITY_CLEAR_TOP or
                Intent.FLAG_ACTIVITY_NEW_TASK or
                Intent.FLAG_ACTIVITY_CLEAR_TASK

        fun <T : Activity> initialize(applicationContext: Context, activityToBeLaunched: Class<T>) =
